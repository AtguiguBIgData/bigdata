...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        String brokers = ConfigManager.getKafkaBrokers();
        String zookeepers = ConfigManager.getZookeeper();
        String from = ConfigManager.getKafkaRecommendFromTopic();
        String to = ConfigManager.getKafkaRecommendToTopic();
